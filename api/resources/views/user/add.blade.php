<div class="container">
    <div class="row" id="userEditor">
        <div class="col-sm-12">
    {!! Form::open(array('url' => 'users/create','id'=>'UserRegistration','class'=>'form-horizontal', 'role'=>'form')) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="surname" name="surname" placeholder="Enter Surname" value="">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="other_name" name="other_name" placeholder="Enter Other Name" value="">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2 pull-right">
            <input type="submit" name="btnsubmit" class="btnsubmit btn btn-success btn-block" value="Save">
        </div>
